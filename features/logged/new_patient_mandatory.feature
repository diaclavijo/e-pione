Feature: Register a new patient filling all the needed fields
  ...
  Scenario Outline: Fill mandatory camps
    ...
    And when I fill in the following:
    |NIF (*)      | <nif>     |
    |Ciudad (*)   | <city>    |
    |Provincia (*)| <state>   |
    |Pais (*)     | <country> |
   ...
   And I fill in the following:
    ...
    | Pepe         |  Paleta        |  12   |  octubre | 2008  |    Hombre       |Soltero        | 9625782   | Las Palmas de Gran Canaria   |  Las Palmas           | España         | 123456789A    |  12345              |  23412412X              |  928430214    | 679023123         |    213214       |C/Tolete Num 4, 4º B  | Desconocido        | Desconocido             | Desconocido  | Pobre    | Desconocido |
    | Pepa         |  La Libre      |  13   |  abril   | 2009  |    Mujer        |Casado         | 53223461  | Las Palmas de Gran Canaria   |  Las Palmas           | España         |  123456789B   |  AAA1               |  123                    |  92843021000  | 679023123         |    2424         |Detrás tuyo           | Lee y escribe      | Manual no especializado | Jubilado     | Mala     | No          |
...
#TODO: Scenario fill optional camps (and mandatory camps) - >Done, a lo bestia.
  #TODO: Scenario not fill mandatory camps
  #TODO: Fecha de nacimiento is tested using names to close to implementation. But it fucking works.
  #TODO: Years begin only from 2008. DCL Children :D  (to fix in implementation)
  #TODO Implementation: Out of range values does not show up well...and then we should make a test for that.
